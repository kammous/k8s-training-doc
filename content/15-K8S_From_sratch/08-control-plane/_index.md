...
The instance IP address will be used to advertise the API Server to members of the cluster.
Retrieve the  IP address for the current compute instance:
