+++
menutitle = "NFS Volume Provisioner"
...
# Dynamic Volume Provisioner with NFS
...
- Create a deployment file using below spec and make sure to modify `<NFS_SERVER_IP>`
...
The Pod will execute a sleep command for 1000 seconds.
You can login to the Pod and verify the volume mount.
